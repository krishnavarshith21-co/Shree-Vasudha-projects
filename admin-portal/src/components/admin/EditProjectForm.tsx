    ...
    <form action={handleSubmit} className="space-y-6 max-w-4xl">
          ...
          <div className="bg-[#141414] border border-white/[0.06] rounded-2xl p-6 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div>
                ...
                <select name="status" required defaultValue={project.status} className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#b59b54]/50 transition-colors appearance-none">
          ...
          <div className="bg-[#141414] border border-white/[0.06] rounded-2xl p-6 space-y-4">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" name="featured" defaultChecked={project.featured} className="sr-only peer" />
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" name="published" defaultChecked={project.published} className="sr-only peer" />
      ...
      >
        <div className="bg-[#141414] border border-white/[0.06] rounded-2xl p-6">
          <ImageUpload name="image_url" defaultValue={project.image_url} label="Primary Project Image (Cover)" />
        </div>
          
        <div className="bg-[#141414] border border-white/[0.06] rounded-2xl p-6">
          <MultiImageUpload name="gallery_images" defaultValues={project.gallery_images} label="Project Gallery (Multiple Images)" />
        </div>
        ...
        <div className="bg-[#141414] border border-white/[0.06] rounded-2xl p-6">
          <FileUpload name="brochure_url" defaultValue={project.brochure_url} label="Brochure (PDF)" accept=".pdf" type="pdf" />
        </div>

        <div className="bg-[#141414] border border-white/[0.06] rounded-2xl p-6">
          <FileUpload name="video_url" defaultValue={project.video_url} label="Walkthrough Video (MP4)" accept="video/mp4,video/webm" type="video" />
        </div>
      </motion.div>
